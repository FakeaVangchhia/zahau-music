  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="relative z-10 w-full max-w-2xl max-h-[90vh] overflow-y-auto bg-card border border-border/80 rounded-3xl shadow-[0_24px_60px_-15px_rgba(0,0,0,0.15)] animate-slide-up"
      >
        {/* Header */}
        ...
        {success ? (
          /* Success state */
          <div className="flex flex-col items-center justify-center gap-6 py-20 px-8 text-center animate-fade-in">
            ...
            <div>
              <h3 className="font-display text-2xl font-bold uppercase tracking-tight mb-2 text-foreground">
                You&apos;re all set!
              </h3>
          ...
          <form onSubmit={onSubmit} className="px-8 py-8 grid gap-8 animate-fade-in">
            {/* Personal Details */}
            ...
            <div className="grid gap-5">
              ...
              {selectedDay && selectedSlot && (
                <div className="flex items-center gap-3 px-4 py-3 rounded-xl bg-azure/10 border border-azure/20 animate-fade-in">
