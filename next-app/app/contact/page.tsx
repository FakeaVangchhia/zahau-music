...
export const metadata: Metadata = {
  ...
  description: "Reach our admissions team and book a free trial online music session.",
  ...
  return (
    <>
      ...
      <section className="py-24 px-6 max-w-7xl mx-auto grid md:grid-cols-[1.3fr_1fr] gap-16 relative">
        ...
        <div className="glass-panel border border-border/60 p-8 rounded-3xl shadow-xl bg-card/30 relative z-10">
          ...
          <p className="mt-3 text-muted-foreground font-light text-sm sm:text-base mb-8">
            We&apos;ll respond within one business day with a recommended faculty and trial class
            slot.
          </p>
          <div>
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <span className="font-sans font-bold text-sm text-foreground block mt-1">
                  WhatsApp Chat
                </span>
              </div>
            </div>
