...
import { Award, BookOpen, Calendar, LogOut, Clock } from "lucide-react";
...
export default function DashboardPage() {
  ...
  if (
    role === "admin" ||
    email.toLowerCase() === "henrysui7@gmail.com" ||
    email.toLowerCase() === "fakeavangchhia@gmail.com"
  ) {
  ...
  return (
    <section className="bg-background min-h-[90vh] py-16 px-6 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10 animate-page-transition">
        {/* Welcome Header */}
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 border-b border-border/80 pb-8 mb-12 animate-fade-in">
          <div>
          ...
          <button
            onClick={signOut}
            className="self-start sm:self-center flex items-center gap-2 border border-border bg-card hover:bg-muted text-foreground px-5 py-3 text-xs font-mono font-bold uppercase tracking-widest rounded-xl transition-all duration-300 hover:scale-[1.03] active:scale-95 shadow-sm cursor-pointer animate-fade-in"
          >
                      ...
                      >
                        ...
                        <div className="flex flex-col items-end text-right gap-1">
                          <span className="text-xs text-muted-foreground">
                            Instructor:{" "}
                            <strong className="text-foreground font-medium">Dr. Henery</strong>
                          </span>
                ...
                {SCHEDULE.map((item) => (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3 self-start sm:self-center">
                      <span
                        className={`text-[10px] font-mono font-bold uppercase tracking-wider px-3 py-1 rounded-lg border ${
                          item.mode === "Online"
