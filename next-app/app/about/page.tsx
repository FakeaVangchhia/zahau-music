...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "About Zahau Music School",
    description: "Mission, vision, founder story and our teaching methodology.",
    url: "/about",
  },
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-[1.2fr_2fr] gap-12 lg:gap-20 items-center relative z-10">
          ...
          <div>
            ...
            <blockquote className="mt-8 border-l-4 border-azure pl-6 font-serif italic text-lg sm:text-xl text-foreground/90">
              &ldquo;We must treat every note as an act of pure attention, where serious craft and
              genuine joy meet.&rdquo;
            </blockquote>
            <div className="mt-8 space-y-5 text-muted-foreground leading-relaxed text-sm sm:text-base font-light">
              <p>
                Henry&apos;s journey began at age six with a borrowed violin in a small Delhi flat.
                Two decades later, he was performing with chamber ensembles in Berlin and Vienna,
