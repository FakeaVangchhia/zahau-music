...
const ITEMS = [
  { src: "/gallery/acoustic-concert.jpg", label: "Live Acoustic Concert", cat: "Concert" },
  { src: "/gallery/guitar-showcase.jpg", label: "Guitar Workshop & Training", cat: "Class" },
  { src: "/gallery/piano-recital.jpg", label: "Classical Piano Recital", cat: "Recital" },
  { src: "/gallery/studio-session.jpg", label: "Music Production & Drum Practice", cat: "Studio" },
  { src: "/gallery/electric-guitars.png", label: "Faculty Guitar Showcase", cat: "Performance" },
  { src: "/gallery/guitar-practice.jpg", label: "Classical Guitar Studio Practice", cat: "Studio" },
  { src: "/gallery/piano-duet.jpg", label: "One-on-One Piano Instruction", cat: "Class" },
  { src: "/gallery/online-class.png", label: "Interactive Online Keyboard Class", cat: "Class" },
  { src: "/gallery/republic-day-poster.jpg", label: "Republic Day Live Event", cat: "Concert" },
];
