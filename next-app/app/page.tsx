      ...
      <ScrollReveal className="py-28 px-6 max-w-7xl mx-auto relative">
        ...
        <div className="grid md:grid-cols-[1fr_2fr] gap-12 mb-20 relative z-10">
          ...
          <p className="text-base sm:text-lg text-muted-foreground leading-relaxed self-end font-light">
            We&apos;ve spent fifteen years refining a single thing: how to bring out the musician
            already inside every student. The result is a curriculum that&apos;s structured, joyful,
            and uncompromising on craft.
          </p>
        </div>
            ...
            <div className="relative z-10 grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="mt-6 text-muted-foreground leading-relaxed font-light text-sm sm:text-base max-w-md">
                  Tell us what you&apos;d like to learn. We&apos;ll match you with a faculty mentor
                  and design a trial class around your goals — free of charge.
                </p>
              </div>
