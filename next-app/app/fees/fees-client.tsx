...
function FeesPageContent() {
  ...
  useEffect(() => {
    if (normalizedPackages.length > 0) {
      if (planParam) {
        const matched = normalizedPackages.find(
          (p: any) =>
  ...
  const estimatedMonthly = activePlan ? Math.round(activePlan.rawFees / durationMonths) : 0;
            ...
            return (
              ...
              >
                ...
                <div className="mb-6">
                  ...
                  <h3 className="font-display text-2xl font-bold uppercase mt-2 leading-tight">
                    {pkg.title}
                  </h3>
          ...
          <div className="grid md:grid-cols-2 gap-10 max-w-4xl mx-auto">
            {HIRE_PACKAGES.map((pkg) => (
              ...
              >
                ...
                <Link
                  href={`/contact?course=${encodeURIComponent("Event Hire: " + pkg.title)}`}
            ...
            <div className="flex flex-col bg-muted/30 dark:bg-card/10 p-8 rounded-3xl border border-border/60 justify-between">
              <div>
                ...
                <div className="text-xs text-muted-foreground mt-2 font-light">
                  Total Course Fee: <strong>{activePlan.fees}</strong> (over {activePlan.duration})
                </div>
                  ...
                  <>
                    ...
                    <div className="grid grid-cols-2 gap-2 mt-2 text-[9px] font-mono border-b border-border/60 pb-6">
                      {[
                        ...
                        <div
                          key={d.name}
                          className="flex items-center gap-1.5 text-muted-foreground font-light"
                        >
                          <span
                  ...
                  <div className="flex gap-3 text-xs">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground font-light">
                        {activePlan.title} ({selectedInstrument})
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3 text-xs">
              ...
              <div className="mt-8">
                <Link
                  href={`/contact?course=${encodeURIComponent(activePlan.title + " (" + selectedInstrument + ")")}`}
