      ...
      <div className="mx-auto max-w-7xl px-6 py-20">
        <div className="grid gap-16 md:grid-cols-[1.4fr_1fr_1fr_1.2fr]">
          <div className="max-w-xs">
            <Link to="/" className="font-display text-4xl tracking-tighter uppercase">
              Zahau
            </Link>
            <p className="mt-6 text-sm text-muted-foreground leading-relaxed">
              Excellence in musical education. Founded by Henry Jahau in Delhi to foster a culture
              of virtuosity and creative exploration.
            </p>
          </div>
          <div className="flex flex-col gap-3">
            ...
            <Link to="/online" className="text-sm text-muted-foreground hover:text-foreground">
              Online Learning
            </Link>
          </div>
          <div className="flex flex-col gap-3">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="text-sm text-muted-foreground">
              Monthly: recitals, workshops, new courses.
            </p>
            <NewsletterForm />
          </div>
        </div>
