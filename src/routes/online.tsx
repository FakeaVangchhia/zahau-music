...
const CARDS = [
  ...
  {
    t: "1-on-1 mentorship",
    d: "A single faculty member stays with you across terms.",
    icon: UserCheck,
  },
  {
    t: "Flexible scheduling",
    d: "Reschedule up to two classes per term, no questions asked.",
    icon: CalendarClock,
  },
  {
    t: "Interactive assignments",
    d: "Weekly play-along tasks and recording uploads.",
    icon: ClipboardList,
  },
  {
    t: "Progress dashboard",
    d: "Track time, repertoire, theory milestones, and recordings.",
    icon: MonitorPlay,
  },
  {
    t: "Studio sessions",
    d: "Visit Delhi twice a year for a recording weekend (optional).",
    icon: Music,
  },
  {
    t: "Global recitals",
    d: "Quarterly online recitals streamed to family and friends.",
    icon: Globe,
  },
  {
    t: "International certification",
    d: "Sit ABRSM and Trinity exams from your home city.",
    icon: Award,
  },
];
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 relative z-10">
          {CARDS.map((card, i) => {
            ...
            return (
              <div
                key={card.t}
                className="glass-panel border border-border/60 hover-glow p-8 rounded-2xl flex flex-col justify-between group min-h-[250px] transition-all duration-300"
              >
                <div>
                  ...
                  <h3 className="font-display text-xl font-bold uppercase tracking-tight group-hover:text-azure transition-colors duration-300 mt-6">
                    {card.t}
                  </h3>
                </div>
