      ...
      <div className="hidden md:flex bg-navy text-navy-foreground p-12 items-center">
        <div>
          ...
          <p className="mt-8 max-w-md text-white/70">
            Track lessons, submit assignments, see your progress, and download your certificates.
          </p>
        </div>
      </div>
      <div className="p-8 md:p-16 max-w-md mx-auto w-full">
        <div className="flex gap-2 mb-8">
          <button
            ...
            className={`px-4 py-2 text-[11px] font-bold uppercase tracking-widest ${mode === "signin" ? "bg-navy text-navy-foreground" : "text-muted-foreground"}`}
          >
            Sign in
          </button>
          <button
            onClick={() => setMode("signup")}
            className={`px-4 py-2 text-[11px] font-bold uppercase tracking-widest ${mode === "signup" ? "bg-navy text-navy-foreground" : "text-muted-foreground"}`}
          >
            Create account
          </button>
        </div>
        <form onSubmit={onSubmit} className="grid gap-4">
          {mode === "signup" && (
            <div className="grid gap-2">
              ...
              <input
                name="full_name"
                required
                className="border border-border bg-card px-4 py-3 text-sm focus:border-azure outline-none"
              />
            </div>
          )}
          <div className="grid gap-2">
          ...
          <button
            disabled={loading}
            type="submit"
            className="bg-azure text-azure-foreground py-3.5 font-bold uppercase tracking-wider text-sm disabled:opacity-50"
          >
        ...
        <button
          onClick={google}
          className="w-full border border-border py-3.5 font-bold uppercase tracking-wider text-sm hover:bg-muted"
        >
