...
export const Route = createFileRoute("/events")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Concerts, student recitals, masterclasses and workshops at Zahau Music School.",
      },
      ...
      <section className="bg-navy text-navy-foreground py-24 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="mt-8 max-w-2xl text-white/70 text-lg">
            Public recitals, concerts, workshops and masterclasses. Everyone welcome.
          </p>
        </div>
      </section>
