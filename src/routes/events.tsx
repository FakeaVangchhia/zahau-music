...
import { Sparkles, Music, Mic, Users, Calendar, ArrowRight, CheckCircle2, Volume2, Shield } from "lucide-react";
...
export const Route = createFileRoute("/events")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Hire professional musicians, soloists, and bands from Zahau Music School for your private, corporate, or festival events.",
      },
...
const EVENT_PACKAGES = [
  {
    ...
    price: "Rs. 10,000",
    badge: "Soloist / Duo",
    description: "Intimate and sophisticated solo or duo performances tailored for weddings, private dinners, art exhibitions, or smaller gatherings.",
    features: [
  ...
  },
  {
    ...
    badge: "Full Ensemble",
    popular: true,
    description: "High-energy, full-band musical experience (4–6 band members) covering pop, jazz, classical, or rock genres to elevate large celebrations and festivals.",
    features: [
      ...
      <section className="bg-navy text-navy-foreground py-32 px-6 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <h1 className="font-display text-6xl sm:text-7xl md:text-8xl lg:text-9xl uppercase leading-none font-extrabold tracking-tight">
            Hire for
            <br />
            <span className="font-serif italic text-azure normal-case font-light lowercase">events.</span>
          </h1>
          <p className="mt-8 max-w-2xl text-navy-foreground/85 text-lg font-light leading-relaxed">
            Elevate your special moments with elite musical craft. Secure outstanding solo performers or high-energy live bands from Zahau Music School for your next event.
          </p>
        </div>
      </section>
              ...
              <div>
                ...
                <div className="mt-8 space-y-3.5">
                  ...
                  {pkg.features.map((feat) => (
                    <div key={feat} className="flex items-start gap-3 text-sm text-foreground/85 font-light">
          ...
          <div className="relative z-10 grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="mt-4 font-display text-4xl md:text-5xl font-extrabold uppercase leading-none tracking-tight">
                Plan Your
                <br />
                <span className="font-serif italic text-azure normal-case font-light lowercase">event.</span>
              </h2>
              <p className="mt-6 text-muted-foreground leading-relaxed font-light text-sm sm:text-base max-w-md">
                Tell us about your event schedule, duration, and desired performance style. We'll match you with the perfect musicians and send a complete, customized quote within 24 hours.
              </p>
              ...
              <div className="mt-10 space-y-4 border-t border-border/40 pt-8 max-w-md">
                <div className="flex gap-3 items-start text-xs text-muted-foreground leading-relaxed">
                  ...
                  <span>All bookings require a 30% advance deposit to secure the date. Sound system and audio engineer cost is quoted separately based on venue requirements.</span>
                </div>
                <div className="flex gap-3 items-start text-xs text-muted-foreground leading-relaxed">
                  <Shield className="size-4 text-azure shrink-0 mt-0.5" />
                  <span>Public liability and artist transport arrangements are fully covered by school travel guidelines.</span>
                </div>
              </div>
            </div>
