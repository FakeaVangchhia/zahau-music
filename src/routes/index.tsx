      ...
      <section className="relative h-[88vh] min-h-[640px] bg-navy text-navy-foreground overflow-hidden flex flex-col justify-center">
        ...
        <div className="relative z-10 px-6 md:px-12 max-w-7xl mx-auto w-full">
          ...
          <p className="mt-8 max-w-xl text-base sm:text-lg leading-relaxed text-white/80 animate-reveal">
            Rigorous conservatory training meets contemporary performance. Join the next generation
        ...
        <div className="absolute bottom-0 w-full border-t border-white/10 bg-navy/80 py-4 overflow-hidden marquee-mask">
          <div className="animate-marquee whitespace-nowrap gap-16">
            {[
              ...
              <span key={i} className="font-display text-4xl text-white/10 uppercase mx-8">
                {w}
              </span>
            ))}
          </div>
      ...
      <ScrollReveal className="py-24 px-6 bg-secondary">
        <div className="max-w-7xl mx-auto">
          <div className="flex justify-between items-end mb-12 flex-wrap gap-4">
            ...
            <Link
              to="/courses"
              className="font-mono text-xs uppercase tracking-widest text-azure hover:text-foreground inline-flex items-center gap-2"
            >
          ...
          {FAQS.map(([q, a]) => (
            <details key={q} className="group py-6">
              <summary className="flex justify-between items-center cursor-pointer list-none">
                ...
                <span className="font-mono text-2xl text-azure group-open:rotate-45 transition-transform">
                  +
                </span>
              </summary>
