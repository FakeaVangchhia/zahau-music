...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Founded by Henry Jahau, Zahau Music School is Delhi's premier music academy with fifteen years of conservatory-grade training." },
      { property: "og:title", content: "About Zahau Music School" },
      { property: "og:description", content: "Mission, vision, founder story and our teaching methodology." },
    ...
    <>
      <section className="bg-navy text-navy-foreground py-24 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <h1 className="mt-4 font-display text-6xl md:text-8xl uppercase leading-none">The art<br />of mastery.</h1>
      ...
      <section className="py-20 px-6 max-w-7xl mx-auto grid md:grid-cols-2 gap-16">
        <div>
          ...
          <h2 className="mt-3 font-display text-4xl uppercase">Train the next generation of world-class musicians.</h2>
        ...
        <div>
          ...
          <h2 className="mt-3 font-display text-4xl uppercase">A culture of musicians, not just hobbyists.</h2>
          <p className="mt-6 text-muted-foreground leading-relaxed">
      ...
      <section className="bg-secondary py-20 px-6">
        <div className="max-w-7xl mx-auto grid md:grid-cols-[1fr_2fr] gap-12 items-start">
          <img src={founderImg} alt="Henry Jahau, founder of Zahau Music School" width={1024} height={1280} loading="lazy" className="w-full" />
          <div>
            ...
            <p className="mt-2 text-muted-foreground font-mono text-sm">Violinist · Conductor · Educator</p>
      ...
      <section className="py-20 px-6 max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-px bg-border border border-border">
          {[
            { t: "Listen first", d: "Every lesson opens with focused listening. You can't play what you can't hear." },
            { t: "Small wins, often", d: "Weekly performance moments — even five minutes for the room — compound into stage confidence." },
            { t: "Theory in context", d: "We teach theory through the music you're playing, not from a separate textbook." },
            { t: "Studio time", d: "Recording is part of the curriculum. Hearing yourself back is the fastest teacher." },
            { t: "Mentorship not instruction", d: "Faculty stay with students across years. The relationship is the curriculum." },
            { t: "Performance is the test", d: "Quarterly recitals replace passive grading. You learn by getting up and playing." },
          ].map((m, i) => (
        ...
        <div className="mt-12">
          <Link to="/contact" className="bg-azure text-azure-foreground px-7 py-4 font-bold uppercase tracking-wider text-sm hover:bg-navy hover:text-navy-foreground transition-colors inline-block">Visit the academy</Link>
        </div>
      </section>
    </>
  );
