...
const courses = [
  {
    ...
    summary:
      "A complete piano programme covering classical repertoire, jazz harmony, sight-reading and performance. Students progress from basic touch and posture through graded exam repertoire to concert-level performance.",
    duration: "12–36 months",
    levels: ["Beginner", "Intermediate", "Advanced", "Performance"],
    curriculum: [
      {
        term: "Term 1: Fundamentals",
        topics: ["Posture and hand position", "Five-finger exercises", "Simple intervals & scales"],
      },
      {
        term: "Term 2: Core Technique",
        topics: ["Major and minor scales", "Basic sight reading", "Hands coordination & pedaling"],
      },
      {
        term: "Term 3: Intermediate Repertoire",
        topics: [
          "Classical pieces (Bach, Mozart, Beethoven)",
          "Dynamic control & expression",
          "Performance preparation",
        ],
      },
      {
        term: "Term 4: Advanced Performance",
        topics: [
          "Concerto repertoire",
  ...
  },
  {
    ...
    summary:
      "Contemporary keyboard for pop, worship and band settings. Students learn chord voicings, rhythmic accompaniment patterns, sound selection and live band coordination.",
    duration: "6–24 months",
    levels: ["Beginner", "Intermediate", "Advanced"],
    curriculum: [
      {
        term: "Term 1",
        topics: ["Chord shapes & voicings", "Pop progressions", "Sound selection & patch design"],
      },
      {
        term: "Term 2",
        topics: ["Rhythmic comping patterns", "Lead lines & fills", "Playing in a band context"],
      },
      {
        term: "Term 3",
        topics: ["Advanced harmony", "Worship & contemporary styles", "Live performance skills"],
      },
    ],
    outcomes: [
      "Play any pop song",
      "Lead a band or worship team",
      "Design and navigate synth sounds",
    ],
  ...
  },
  {
    ...
    slug: "guitar",
    name: "Modern Guitar",
    tagline: "Ukelele, Classical, Bass Guitar & Electric",
    summary:
      "Comprehensive guitar programme covering acoustic, electric, bass, classical and ukelele. From open chords and basic strumming to advanced soloing, fingerpicking, and performance across all styles.",
    ...
    curriculum: [
      {
        ...
        topics: [
          ...
          "Basic fingerpicking",
          "First songs & music reading",
        ],
      },
      {
        term: "Term 2: Technique",
        topics: ["Barre chords", "Pentatonic & major scales", "Lead guitar basics"],
      },
      {
        term: "Term 3: Styles",
        topics: [
          "Classical technique (nylon string)",
          "Electric soloing & effects",
          "Bass guitar grooves & bass lines",
          "Ukelele chords & strumming",
        ],
      },
      {
        term: "Term 4: Performance",
        topics: ["Stage performance skills", "Advanced repertoire", "Recording & tone shaping"],
      },
    ],
    outcomes: [
      "Play & sing across all styles",
      "Solo over backing tracks",
      "Read TAB & standard notation",
      "Perform on stage confidently",
    ],
  ...
  },
  {
    ...
    summary:
      "Acoustic and electronic drumming — rudiments, grooves, fills and live performance. Students develop timing, independence and stylistic versatility across rock, jazz, pop and Latin genres.",
    duration: "6–36 months",
    levels: ["Beginner", "Intermediate", "Advanced", "Performance"],
    curriculum: [
      {
        term: "Term 1: Fundamentals",
        topics: ["Single & double strokes", "Basic rock beat", "Counting & subdivisions"],
      },
      {
        term: "Term 2: Grooves",
        topics: ["16th-note patterns", "Hi-hat variations", "Fills & transitions"],
      },
      {
        term: "Term 3: Styles",
        topics: ["Jazz brush technique", "Latin patterns", "Playing with a click track"],
      },
      {
        term: "Term 4: Performance",
        topics: [
    ...
    outcomes: [
      "Play in a live band",
      "Record drum tracks professionally",
      "Play across rock, jazz, Latin & pop styles",
    ],
  ...
  },
  {
    ...
    summary:
      "Comprehensive vocal training across all three major traditions — Hindustani classical, Carnatic classical, and Western contemporary. Students develop healthy technique, repertoire depth and powerful stage presence.",
    duration: "6–36 months",
    levels: ["Beginner", "Intermediate", "Advanced", "Performance"],
    curriculum: [
      {
        ...
        topics: [
          ...
          "Range exploration & warm-ups",
          "Pitch accuracy & tone quality",
        ],
      },
      {
        term: "Term 2: Style Streams",
        topics: [
          "Hindustani: Ragas & Taal basics",
          "Carnatic: Swara & Varna",
          "Western: Contemporary pop technique & belting",
        ],
      },
      {
        term: "Term 3: Repertoire",
        topics: [
          "Song selection & interpretation",
          "Mic technique & stagecraft",
          "Ensemble & harmony singing",
        ],
      },
      {
        term: "Term 4: Performance",
        topics: ["Concert preparation", "Recording vocals in studio", "Exam & recital performance"],
      },
    ],
    outcomes: [
      "Sing confidently on stage",
      "Perform in Hindustani, Carnatic or Western style",
      "Studio-ready vocal technique",
      "Control pitch, breath and dynamics",
    ],
  ...
  },
  {
    ...
    summary:
      "The shared language of music — reading, writing, analysing, hearing and understanding musical structure. Covers written theory, oral theory, ear training, dictation, and harmony for all instruments and styles.",
    ...
    curriculum: [
      {
        ...
        topics: [
          ...
          "Major/minor scales & keys",
          "Intervals & basic harmony",
        ],
      },
      {
        term: "Term 2: Ear Training",
        topics: [
          "Melodic dictation",
          "Chord recognition by ear",
          "Rhythmic dictation & sight-singing",
        ],
      },
      {
        term: "Term 3: Written & Oral Theory",
        topics: ["Four-part harmony", "Oral theory examinations", "Analysis of musical forms"],
      },
      {
        term: "Term 4: Advanced",
        topics: [
          "Modal harmony & jazz theory",
    ...
    outcomes: [
      "Read & write music fluently",
      "Develop a trained musical ear",
      "Compose simple pieces",
      "Pass ABRSM Theory of Music grades",
    ],
...
async function run() {
  ...
  const { error: deleteError } = await supabase
    .from("fees")
    .delete()
    .neq("title", "placeholder_force_nonempty_dummy_string");
  if (deleteError) {
