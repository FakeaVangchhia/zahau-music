...
const courses = [
  ...
  },
  {
    ...
    summary: 'Comprehensive guitar programme covering acoustic, electric, bass, classical and ukelele. From open chords and basic strumming to advanced soloing, fingerpicking, and performance across all styles.',
    ...
    curriculum: [
      ...
      {term: "Term 3: Styles", topics: ["Classical technique (nylon string)", "Electric soloing & effects", "Bass guitar grooves & bass lines", "Ukelele chords & strumming"]},
