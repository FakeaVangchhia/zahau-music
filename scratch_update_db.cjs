...
const courses = [
  ...
  },
  {
    ...
    summary:
      "Comprehensive guitar programme covering acoustic, electric, classical and ukulele. From open chords and basic strumming to advanced soloing, fingerpicking, and performance across all styles.",
